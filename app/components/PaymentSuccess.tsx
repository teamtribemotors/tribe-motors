...
export default function PaymentSuccess({ vehicle, transactionId, date }: PaymentSuccessProps) {
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-margin-mobile md:px-margin-desktop py-stack-xl">
        <div className="max-w-[600px] w-full flex flex-col items-center text-center space-y-stack-lg">
          ...
          <div className="flex flex-col items-center space-y-stack-md animate-[fadeIn_0.5s_ease-out]">
            <div className="w-20 h-20 bg-tertiary/10 rounded-full flex items-center justify-center mb-stack-sm">
              <span className="material-symbols-outlined text-[48px] text-tertiary" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
            </div>
            <h1 className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-background">Report Unlocked</h1>
          ...
          <div className="w-full bg-surface-container-lowest border border-outline-variant/30 rounded-xl p-stack-md shadow-[0_4px_24px_rgba(41,23,19,0.03)] text-left flex flex-col gap-stack-sm">
            ...
            <div className="flex justify-between items-center py-stack-sm border-b border-surface-variant/50">
              <span className="font-label-md text-label-md text-on-surface-variant uppercase tracking-wider">Amount Paid</span>
          ...
          <div className="bg-surface-container-low rounded-lg p-stack-md border border-surface-variant/50 max-w-[500px]">
            <div className="flex items-start gap-stack-sm">
              ...
              <p className="font-body-md text-body-md text-on-surface text-left leading-relaxed">
                Our concierge team is finalizing your report. A secure link to the full PDF will be sent to your registered WhatsApp number within 15 minutes.
              </p>
            </div>
          </div>
          ...
          <div className="pt-stack-sm w-full sm:w-auto">
            <Link href={`/vehicle/${vehicle.id}`} className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-on-primary font-label-md text-label-md h-[48px] px-stack-xl rounded transition-colors duration-200 flex items-center justify-center gap-1 shadow-[0_4px_12px_rgba(176,38,0,0.15)]">
