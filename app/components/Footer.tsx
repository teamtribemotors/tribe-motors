...
export default function Footer() {
  return (
    <footer className="full-width bg-primary mt-stack-lg flex flex-col items-center gap-base py-stack-lg px-margin-desktop w-full">
      <div className="font-headline-md text-headline-md font-bold text-on-primary mb-4">
        Tribe Motors
      </div>
      ...
      <p className="font-body-md text-body-md text-on-primary opacity-60 text-center">
