                    ...
                    <div className="bg-surface-container-lowest rounded-xl border border-outline-variant overflow-visible shadow-sm">
                        {records.length === 0 ? (
                            <div className="py-20 flex flex-col items-center justify-center text-center">
                                <span className="material-symbols-outlined text-6xl text-on-surface-variant/50 mb-4">build</span>
                                <h3 className="font-headline-md text-headline-md text-on-surface mb-2">No service records</h3>
                                <p className="font-body-md text-body-md text-on-surface-variant mb-6 max-w-md">You haven't logged any service, maintenance, or repair records yet.</p>
                                <Link href="/staff/records/new" className="bg-primary text-on-primary font-label-bold text-label-bold py-2 px-6 rounded-lg shadow-sm hover:opacity-90 transition-opacity flex items-center gap-2">
                                    <span className="material-symbols-outlined">add</span>
                                    Add First Record
                                </Link>
                            </div>
