...
<button className="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 w-10 bg-[#f1ebea] text-[#181210] transition-colors hover:bg-surface-dim">
...
<h3 className="text-on-surface text-xl font-bold leading-tight">2021 Honda City</h3>
...
<div className="w-24 h-24 bg-center bg-no-repeat bg-cover rounded-lg shadow-sm border border-white" data-alt="A side-profile high-resolution photograph of a pristine 2021 Honda City in a sleek metallic silver finish. The car is positioned in a professional automotive studio with soft, cinematic lighting reflecting off its polished surfaces. The background is a minimalist, neutral gray, emphasizing the car's modern design and sophisticated silhouette. The atmosphere is clean, premium, and focused on luxury automotive presentation." style={{"backgroundImage":"url(\"https://lh3.googleusercontent.com/aida-public/AB6AXuBEEwTB0R2jrUs0Td1GoqGFjWP5QP0himxrHHOHCCE4njS050l-sg0G-0tg8ww25bP20tFGpW_NZbchVRwqb6pWYujV_Xl9ACi1CkhrNW1ACx1tIQyNoZe1aH-tkUCrlahSJtZkgZifZucsc01VTDerm8NVoFJOcAj0ly5YDORs1zrdHIBeBeKldXeAZSodnRFFf4hsK-pK4hxCd4v5NGso93-0nvYtV6vj1nYOchoe9_hauHsPT0k\")"}}>
</div>
</div>
</div>
...
<img className="h-full object-contain" data-alt="A clean, vector-style logo for Razorpay in blue and white, representative of a secure payment gateway. The logo is minimalist and professional, set against a transparent background to blend into the UI." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCbtRg8jNu0TS-g6693W2D96G1xqTHVtW18SP60hsW_wQ-wMJ_xOTppKMbR98iyXtxHjhet5YJ0G76dJMmAZXVU04cnLh_FxGwB-BCL5CknzB5CDjHcgKCZKyEdvlCvnh-nWMNdq3wWfs3CFhUNVIi2vGYRdfNKXVmhBYMPRy-iNV9oD5L2mBkSGjvI1IoOo7sQJdq3t9Wm4wBu8OvIo8XCHvE7p6-5zyMMwGVQeTf--l-GyJ5piPM"/>
</div>
<div className="h-6 w-16 flex items-center justify-center">
<img className="h-full object-contain" data-alt="A standard PCI-DSS certified security badge, featuring a shield icon and clean sans-serif typography. The design is authoritative and reassuring, rendered in a professional monochrome style suitable for a high-end checkout interface." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCLkNzYmgNAixyl35RqPsR-PpinORCdoUN7lCONuBNSEEbB5PgKlolbV9sSZmSfzpvBFG0tdtESziAGbOss0FWF9-9Btys-mthKBo6tebp9ZT7YxS9iDoXaetzkx0TY2GAUYJHJWcrRyjXfvWTCUhUtxrG_8TEdMb2A89YP3SR3mkBLCx79Pjw29E3umLJgRPpZaUlURexTW1OIJeuKEJvX06nSGQ0e3-FUhbAtgbPW7susklpTGMA"/>
</div>
<div className="h-6 w-16 flex items-center justify-center">
<img className="h-full object-contain" data-alt="A stylized Visa and Mastercard dual logo, representative of global credit card acceptance. The icons are crisp, recognizable, and presented in a clean, minimalist vector format with professional spacing." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAwD9Q9PYyy4mWOc6jmKnvvMdvgIiSkKC_28Ox_weuNQqcRLfEr6EefbGUvylsmfIN8sG3eqxCDaGQ8XCeVRjItt9-OieHMPSbCzyGvoutE_2GCg0S5qOjpIBQlf4wwl11jAvcYHst-j_A7qFrYz2vihxwgopVLu3DTCY5xJf2KTxVn6NOza3NS4gTLWobC9T_7H6PLhyJ6_YIhn5TLco_6zCn5Q9wendnNY17S8hT3nh_nS7hr2JM"/>
</div>
</div>
