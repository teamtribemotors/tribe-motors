...
<nav className="bg-surface dark:bg-on-background shadow-sm dark:shadow-none w-full max-w-container-max mx-auto px-margin-desktop h-20 flex justify-between items-center sticky top-0 z-50">
...
<button className="font-label-bold text-label-bold text-primary hover:opacity-80 transition-opacity scale-95 duration-150 ease-in-out px-4 py-2">
                Sign In
            </button>
</div>
</nav>
